...
function contact() {
	return (
		<div style={{ backgroundColor: "#f8f5f2" }}>
			...
			*/}
			<div id='map-container-google-1' class={styles["z-depth-1-half map-container"]}>
				<iframe
							...
							<Col style={{ display: "flex", justifyContent: "center" }}>
								<div className={style.phone-contact}>
									...
									<div>
										...
										<p className={styles["call-data archivo-normal-black-pearl-3-5rem-700"]}>
											8888735224
										</p>
									</div>
								</div>
							...
							<Col style={{ display: "flex", justifyContent: "center" }}>
								<div className={styles["whats-app-contact"]}>
									...
									<div>
										...
										<p className={styles["whatsapp-data archivo-normal-black-pearl-3-5rem-700"]}>
											9423365393
										</p>
									</div>
								</div>
