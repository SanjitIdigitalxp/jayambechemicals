		...
		<div className={styles.all-the-details-of-about-us-center}>
			...
			<div className={styles.profile-pic-container}>
				<div className={styles.profile-pic-1}>
					<img src='img/image1.jfif' className='profile-pic-individual'></img>
				</div>
				<div className={styles.profile-pic-2}>
					<img src='img/image2.jfif' className='profile-pic-individual'></img>
				</div>
				<div className={styles.profile-pic-1}>
					<img src='img/image3.jfif' className='profile-pic-individual'></img>
				</div>
			</div>
			<div className={styles.about-us-details-center-container}>
				<div className={styles.about-us-details-center}>
					<div className={styles["title-about-text archivo-black-about-topic-us-title-4rem"]}>
						About Us
					</div>
				...
				<div className={styles.width-of-value-div}>
					<Row className={styles.row-width-size}>
						<Col className={styles.value-multi-column}>
							<div>
								<div className={styles["our-value-sub-topic archivo-normal-black-pearl-2-5rem-500"]}>
									Responsible
								</div>
								<p className={styles["archivo-normal-black-pearl-2rem-550"]}>
			...
			<div className={styles["group-7801 archivo-normal-black-pearl-1-4rem"]}
